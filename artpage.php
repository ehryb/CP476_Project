            ...
            <div class="clearfix">
                ...
                <table>
                    <tr>
                     ...
                     <tr>
                         <?php
                        $query_user1 = "SELECT * FROM art_reviews where art_id = ".$id." and critic = false";
                        $result_user1= runQuery($conn, $query_user1);
                        $query_user2 = "SELECT * FROM art_reviews where art_id = ".$id." and critic = true";
        ...
        <div class = "new-lines">
         ...
         <div id = "ReviewBox">
            <table id = "critic_table">
                ...
                <?php
                    $query_critic = "SELECT * FROM art_reviews where art_id = ".$id." and critic = true";
            ...
            <table id = "audience_table">
                ...
                <tr>
                 ...
                 <?php
                    $query_user = "SELECT * FROM art_reviews where art_id = ".$id." and critic = false";
                        ...
                        <script>
                            function clicked(e)
                            {
                                if(!confirm('Are you sure you would like to submit this review?')){
                                    ...
                                    var url = "addReview.php?type=art&id=" + movie_id + "&review=" + new_review + "&score=" +new_score;
